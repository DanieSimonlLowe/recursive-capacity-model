...
class NotKnotSplineSocOcvCurve: SocOcvCurveBase {
    public:
        NotKnotSplineSocOcvCurve(const OcvSocData &data, const Eigen::VectorXd& params = Eigen::VectorXd());
